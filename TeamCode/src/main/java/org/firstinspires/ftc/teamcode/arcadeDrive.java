...
public class arcadeDrive extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        webcam.setPipeline(new ColorDetPipeline());
        ...
        webcam.openCameraDeviceAsync(new OpenCvCamera.AsyncCameraOpenListener() {
            ...
            public void onOpened() {
                ...
                FtcDashboard.getInstance().startCameraStream(vuforia, 20);

                telemetry.addData("camera on", vuforia);
    ...
    public static class ColorDetPipeline extends OpenCvPipeline
    {
        /*
